...
export class CreateStoryboardDto {
  @ApiPropertyOptional({ description: 'Unique ID for the storyboard' })
  @IsString()
  @IsOptional()
  id?: string;

  @ApiProperty({ description: 'Title of the storyboard' })
  @IsString()
  title: string;

  @ApiProperty({ description: 'Duration of the storyboard (e.g., "30s")' })
  @IsString()
  duration: string;
  ...
  @ApiPropertyOptional({
    description: 'Creation date of the storyboard',
  ...
  @ApiProperty({
    type: [SceneDto],
    description: 'Detailed data for each scene in the storyboard',
  })
  @IsArray()
