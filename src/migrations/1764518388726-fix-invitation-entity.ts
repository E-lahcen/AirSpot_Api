...
export class FixInvitationEntity1764518388726 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "creatives" DROP COLUMN IF EXISTS "filename"`,
    );
    await queryRunner.query(
      `ALTER TABLE "creatives" DROP COLUMN IF EXISTS "file_name"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "invitations" DROP CONSTRAINT IF EXISTS "UQ_invitations_token"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "ad_variations" DROP CONSTRAINT IF EXISTS "FK_bceb3bc20c04e95c433d936e8bc"`,
    );
    await queryRunner.query(
      `ALTER TABLE "creatives" DROP CONSTRAINT IF EXISTS "FK_8fc1c0e62b2d5d19e27fb5f816a"`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "creatives" ADD "filename" character varying(500)`,
    );
    await queryRunner.query(
